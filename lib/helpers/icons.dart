...
extension CustomIcons on ColorScheme {
  ...
  String get groupsIcon => iconPath + 'groups-svgrepo-com.svg';

  String get coursesIcon => iconPath + 'education-cap-svgrepo-com.svg';

  String get marketplaceIcon => iconPath + 'shopping-bag-svgrepo-com.svg';

  String get docsIcon => iconPath + 'document-text-svgrepo-com.svg';
